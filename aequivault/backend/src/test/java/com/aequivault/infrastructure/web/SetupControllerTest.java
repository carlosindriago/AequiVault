...
class SetupControllerTest {
    ...
    @Test
    void shouldReturnNotInitializedStatusWhenDatabaseIsEmpty() throws Exception {
    ...
    @Test
    void shouldInitializeSystemAndIssueJwtToken() throws Exception {
        String setupPayload = """
                {
    ...
    @Test
    void shouldPreventReInitializationIfSystemAlreadyInitialized() throws Exception {
        String setupPayload = """
                {
                    "companyName": "Empresa Test SA",
                    "email": "admin@empresa.com",
        ...
        mockMvc.perform(post("/api/v1/setup/init")
                ...
                .andExpect(jsonPath("$.detail").value("El sistema ya ha sido inicializado."));
    }
}
